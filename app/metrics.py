...
active_deck_generations = Gauge(
    "deckflow_active_deck_generations", "Number of currently active deck generations"
)

slide_generation_total = Counter(
    "deckflow_slide_generation_total", "Total number of slides generated"
)

llm_requests_total = Counter(
    "deckflow_llm_requests_total", "Total LLM API requests", ["model", "status"]
)

llm_request_duration_seconds = Histogram(
    "deckflow_llm_request_duration_seconds", "LLM request duration", ["model"]
)
