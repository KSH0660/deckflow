...
from app.service.content_creation.models import SlideContent, COLOR_THEME_MAPPING, LAYOUT_TYPE_ASSET_MAPPING
...
class TestColorThemeMapping:
    ...
    def test_color_theme_completeness(self):
        ...
        expected_themes = {
            'professional_blue', 'corporate_gray', 'vibrant_purple',
            'modern_teal', 'energetic_orange', 'nature_green',
            'elegant_burgundy', 'tech_dark', 'warm_sunset', 'minimal_monochrome'
        }
...
class TestLayoutTypeAssetMapping:
    ...
    def test_layout_asset_mapping_structure(self):
        ...
        expected_layouts = {
            'title_slide', 'content_slide', 'comparison', 'data_visual',
            'process_flow', 'feature_showcase', 'testimonial', 'call_to_action'
        }
